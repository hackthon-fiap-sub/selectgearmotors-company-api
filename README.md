...
1. Clone o repositório:
    ```bash
    git clone https://github.com/fiapg70/sevenfood-company-api
    cd sevenfood-company-api
    ```
...
2. Configure as variáveis de ambiente:
   ...
   - Configure os campos:
      ...
      - **Main class**: `br.com.sevenfood.company.sevenfoodclientapi.RunApplication` (substitua `br.com.sevenfood.company.sevenfoodclientapi.RunApplication` pela sua classe principal)
